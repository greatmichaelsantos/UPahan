      ...
      <div className="flex flex-col items-center flex-1 justify-center w-full">
        ...
        <div
          ...
          style={{
            ...
            background: '#277571',
            boxShadow: '0 8px 32px rgba(39,117,113,0.25)',
          }}
        >
        ...
        <h1 style={{
          fontFamily: 'Inter',
          fontWeight: 700, fontSize: 42, color: '#277571',
        ...
        <p style={{
          ...
          Your Properties. Managed Smarter.
        </p>
      </div>
      ...
      <div style={{ width: '100%', paddingBottom: 48 }}>
        <button
          ...
          style={{
            ...
            width: 240, height: 52,
            background: '#277571', color: 'white',
            borderRadius: 8, border: 'none',
            fontFamily: 'Inter', fontWeight: 700, fontSize: 15,
            letterSpacing: '0.04em', cursor: 'pointer',
            boxShadow: '0 4px 16px rgba(39,117,113,0.25)',
            transition: 'all 150ms ease',
          }}
          onMouseOver={e => { e.currentTarget.style.boxShadow = '0 6px 24px rgba(39,117,113,0.35)'; e.currentTarget.style.transform = 'scale(1.01)'; }}
          onMouseOut={e => { e.currentTarget.style.boxShadow = '0 4px 16px rgba(39,117,113,0.25)'; e.currentTarget.style.transform = 'scale(1)'; }}
        >
          GET STARTED
        </button>
        <p style={{ textAlign: 'center', marginTop: 24, fontFamily: 'Inter', fontSize: 11, color: '#999999', letterSpacing: '0.04em' }}>
