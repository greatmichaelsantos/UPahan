...
export default function TenantDashboard() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FAF8F5', paddingBottom: 80 }}>
      ...
      {/* Top header */}
      <div style={{ background: 'white', padding: '20px 20px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', boxShadow: '0 1px 8px rgba(46,125,114,0.06)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <svg width="22" height="22" viewBox="0 0 32 32" fill="none" aria-hidden="true">
            <path d="M16 3L3 14h3v14h8v-8h4v8h8V14h3L16 3z" fill="#2E7D72" />
          </svg>
          <span style={{ fontFamily: '"Playfair Display", Georgia, serif', fontWeight: 700, fontSize: 18, color: '#2E7D72' }}>UPAHAN</span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <NotificationBell />
          <span style={{ fontFamily: 'Inter', fontSize: 13, color: '#4A4A4A', fontWeight: 600 }}>{user?.first_name} {user?.last_name}</span>
          <div style={{ width: 36, height: 36, borderRadius: '50%', background: '#3A7BD5', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <span style={{ fontFamily: 'Inter', fontWeight: 700, fontSize: 14, color: 'white' }}>
      ...
      <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        {/* Monthly rent card */}
        <div style={{ background: '#2E7D72', borderRadius: 16, padding: 24 }}>
          ...
          <p style={{ fontFamily: '"Playfair Display", Georgia, serif', fontWeight: 700, fontSize: 40, color: 'white', margin: '4px 0 12px' }}>
          ...
          {!loadingStatus && (
            hasPending ? (
              <div style={{
                background: 'rgba(255,255,255,0.12)', borderRadius: 8, padding: '10px 14px',
                fontFamily: 'Inter', fontWeight: 600, fontSize: 13, color: 'rgba(255,255,255,0.85)',
                textAlign: 'center',
              }}>
          ...
          <div className="card">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <Home size={14} color="#2E7D72" />
                <span style={{ fontFamily: 'Inter', fontWeight: 700, fontSize: 14, color: '#2E7D72' }}>{unitDetail.unit_code}</span>
              </div>
            </div>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                {unitDetail.bedrooms && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    ...
                    <p style={{ fontFamily: 'Inter', fontSize: 12, color: '#888' }}>{unitDetail.bedrooms} bedroom{unitDetail.bedrooms !== '1' ? 's' : ''}</p>
                  </div>
                )}
              </div>
            </div>
          ...
          return (
            <div className="card">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontFamily: 'Inter', fontSize: 11, marginTop: 2, fontWeight: 600,
                      color: !idDoc ? '#AAAAAA' : idDoc.status === 'verified' ? '#2E7D72' : idDoc.status === 'rejected' ? '#D64045' : '#E07B39'
                    }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{ width: 36, height: 36, borderRadius: 8, background: '#F0F9F7', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <FileText size={18} color="#2E7D72" />
                  </div>
                  <div>
                    <p style={{ fontFamily: 'Inter', fontWeight: 600, fontSize: 13, color: '#4A4A4A' }}>Lease Contract</p>
                    <p style={{ fontFamily: 'Inter', fontSize: 11, marginTop: 2, fontWeight: 600, color: contract ? '#2E7D72' : '#AAAAAA' }}>
                ...
                {contract && (
                  <a
                    ...
                    style={{ padding: '7px 16px', background: '#F0F9F7', color: '#2E7D72', border: '1.5px solid #2E7D72', borderRadius: 8, fontFamily: 'Inter', fontWeight: 700, fontSize: 12, textDecoration: 'none' }}
                  >
                    View
                  </a>
                )}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          ...
          >
            <div style={{ width: 44, height: 44, borderRadius: 10, background: '#E8F5F3', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Clock size={22} color="#2E7D72" aria-hidden="true" />
            </div>
