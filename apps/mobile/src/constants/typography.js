export const FONTS = {
  ...
  bodyMedium:     { fontSize: 14, fontWeight: '400', color: '#666666' },
  bodySmall:      { fontSize: 12, fontWeight: '400', color: '#999999' },
  amountLarge:    { fontSize: 32, fontWeight: '700', color: '#1A1A1A' },
  amountMedium:   { fontSize: 20, fontWeight: '700', color: '#1A1A1A' },
  amountOnCard:   { fontSize: 32, fontWeight: '700', color: '#FFFFFF' },
};
