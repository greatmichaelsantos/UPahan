...
export default function EmptyState({ icon = 'cube-outline', title, message, iconColor = COLORS.landlordPrimary, iconBg = COLORS.landlordLight }) {
  return (
    <View style={s.wrap}>
...
const s = StyleSheet.create({
  ...
  title:   { fontSize: 18, fontWeight: '700', fontFamily: 'Inter_700Bold', color: COLORS.textPrimary, marginBottom: 8, textAlign: 'center' },
